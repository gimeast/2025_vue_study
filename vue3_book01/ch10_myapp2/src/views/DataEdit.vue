  ...
  <div class="content">
    ...
    <form @submit.prevent="submitEdit">
      <div class="field">
        ...
        <div class="control">
          <input type="text" class="input" v-model="editableData.title" required />
        </div>
      </div>
      <div class="field">
      ...
      <div class="field">
        ...
        <div class="control">
          <input type="text" class="input" v-model="editableData.author" required />
        </div>
      </div>
      <div class="field">
        ...
        <div class="control">
          ...
          <p class="help">
            현재 파일:
            <a :href="editableData.datafile" target="_blank">{{ editableData.datafileName }}</a>
          </p>
        </div>
      </div>
      <div class="field is-gouped">
        <div class="control">
          <button class="button is-link" type="submit">[글 수정]</button>
        </div>
        <div class="control">
          <button class="button" type="button" @click="goToList">취소</button>
        </div>
      </div>
    </form>
  </div>
...
const fetchDataDetail = async () => {
  ...
  editableData.value = {
    ...
    datafile: current.datafile,
    datafileName: current.datafileName,
    resdate: current.resdate,
    hits: current.hits,
    newDatafile: current.newDatafile,
  }
}
